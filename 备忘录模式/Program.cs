    ...
    class Program
    {
        static void Main(string[] args)
        {
            List<ContactPerson> persons = new List<ContactPerson>()
            {
                ...
                new ContactPerson() { Name = "Jock2", MobileNum = "222222"},
                new ContactPerson() { Name = "Jock3", MobileNum = "333333"},
                new ContactPerson() { Name = "Jock4", MobileNum = "444444"},
                new ContactPerson() { Name = "Jock5", MobileNum = "555555"}
            };
